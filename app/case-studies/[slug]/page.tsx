  ...
  return (
    <main className="min-h-screen pt-32 pb-24 bg-slate-50 dark:bg-slate-950/50 transition-colors duration-500">
      <div className="container mx-auto px-4 max-w-4xl relative z-10">
        ...
        <div className="bg-white dark:bg-slate-900 p-8 md:p-12 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-slate-800">
          <article className="prose prose-lg dark:prose-invert prose-slate max-w-none
            prose-headings:font-black prose-headings:tracking-tighter prose-headings:font-heading
