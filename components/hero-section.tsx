...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-background via-card/30 to-accent/5 dark:from-background dark:via-background dark:to-accent/10">
      ...
      <div className="absolute inset-0">
        <motion.div
          className="absolute top-20 left-10 w-20 h-20 bg-gradient-to-r from-accent/10 to-primary/10 dark:from-accent/20 dark:to-primary/20 rounded-full blur-xl"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.2, 0.4, 0.2],
          }}
        ...
        />
        <motion.div
          className="absolute top-40 right-20 w-32 h-32 bg-gradient-to-r from-secondary/10 to-accent/10 dark:from-secondary/20 dark:to-accent/20 rounded-full blur-2xl"
          animate={{
            scale: [1, 1.3, 1],
        ...
        />
        <motion.div
          className="absolute bottom-20 left-1/4 w-24 h-24 bg-gradient-to-r from-accent/8 to-primary/8 dark:from-accent/15 dark:to-primary/15 rounded-full blur-xl"
          animate={{
            scale: [1, 1.1, 1],
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <FadeIn delay={0.2}>
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-accent/5 to-primary/5 dark:from-accent/10 dark:to-primary/10 text-accent px-4 py-2 rounded-full text-sm font-medium mb-6 border border-accent/20 backdrop-blur-sm">
          ...
          <StaggerContainer staggerDelay={0.1} className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <ScaleIn delay={0.8}>
              <div className="space-y-2 p-6 rounded-lg bg-gradient-to-br from-card/80 to-accent/3 dark:from-background/50 dark:to-accent/5 backdrop-blur-sm border border-accent/10 hover:border-accent/20 transition-all duration-300 hover:shadow-lg">
      ...
      <div className="absolute bottom-10 right-10 opacity-10 dark:opacity-30">
        <LottieAnimation
