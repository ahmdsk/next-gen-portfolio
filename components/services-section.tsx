      ...
      <div className="container mx-auto px-4">
        ...
        <StaggerContainer staggerDelay={0.15} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            ...
            >
              <Card
                className={`h-full hover:shadow-xl transition-all duration-300 group hover:border-accent/50 bg-gradient-to-br ${service.gradient} backdrop-blur-sm border-accent/20`}
              >
                <CardContent className="p-6">
                  <div className="mb-4">
                    <ScaleIn delay={index * 0.1 + 0.3}>
                      <div className="w-12 h-12 bg-gradient-to-br from-accent/20 to-accent/10 rounded-lg flex items-center justify-center mb-4 group-hover:from-accent/30 group-hover:to-accent/20 transition-all duration-300">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full group-hover:border-accent group-hover:text-accent bg-transparent hover:bg-accent/10 transition-all duration-300"
                  >
                    Cek Lebih Detail
                  </Button>
                </CardContent>
